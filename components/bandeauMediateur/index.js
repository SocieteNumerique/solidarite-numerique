...
const BandeauMediateur = () => (
  ...
  <div>
    <link rel="stylesheet" href="/libs/france-services/lib/leaflet.css">
    <link rel="stylesheet" href="/libs/france-services/lib/leaflet-sidebar.min.css">
    <link rel="stylesheet" href="/libs/france-services/lib/awesomplete.css">
    <link rel="stylesheet" href="/libs/france-services/lib/L.Control.ZoomMin.css">
    <link rel="stylesheet" href="/libs/france-services/css/font.css">
    <link rel="stylesheet" href="/libs/france-services/css/style.css">
    <script src="/libs/france-services/lib/tabletop.min.js"></script>
    <script src="/libs/france-services/lib/leaflet.js"></script>
    <script src="/libs/france-services/lib/leaflet-sidebar.min.js"></script>
    <script src="/libs/france-services/lib/L.Control.ZoomMin.js"></script>
    <script src="/libs/france-services/lib/awesomplete.min.js"></script>
    <script src="/libs/france-services/lib/feather.min.js"></script>
  <select type="menu" id = "goTo">
   ...
   <div id="sidebar" class="leaflet-sidebar collapsed">
       ...
       <div class="leaflet-sidebar-content">
           <div class="leaflet-sidebar-pane" id="home">
               ...
               <h3><i>Carte interactive</i> <br>
                 <img src="/libs/france-services/img/logo_FranceServices-01.png" id = "logo_fs">
              </h3>
              <div id = "legende">
              </div>
               <p>
           ...
           <div class="leaflet-sidebar-pane" id="autopan">
            ...
            <div class="leaflet-sidebar-pane" id="a-propos">
                ...
                <img src="/libs/france-services/img/logo_anct.png" width="80%">
                <p><i>En partenariat avec</i></p>
                <img src="/libs/france-services/img/logo_bdt.png" width="80%">
             </div>
           </div>
       </div>
    </div>
    ...
    <script src="/libs/france-services/js/app.js"></script>
    <script src= "/libs/france-services/js/legend.js"></script>
    <script type="/libs/france-services/javascript">feather.replace()</script>
    </div>
