      ...
      <div className="container content-container">
        <div>
          <a
              ...
              target="_blank"
            >
              <h4>Vous aimez le contact humain, cherchez un métier qui a du sens dans un secteur d’avenir? Rejoignez le mouvement national des conseillers numériques!</h4>
              <img
