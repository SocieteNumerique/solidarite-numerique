    ...
    <Page title="Mentions Légales">
      <div className="text-container">
        ...
        <p>
          ...
          <b>
            Votre code postal, qui nous permettra d’identifier, par le biais d’une enquête statistique anonymisée, les besoins spécifiques en accompagnement numérique de chaque territoire;<br />
            Vos nom et prénom, afin de personnaliser le service que nous vous apportons;<br />
            Votre adresse mail, si vous souhaitez que nous vous envoyons des ressources.<br />
          </b>
        </p>
      </div>
    </Page>
